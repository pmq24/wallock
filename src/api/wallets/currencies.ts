...
export const CODES: string[] = Object.keys(data).sort()

export function fromCode(code: string): Currency | undefined {
  if (code in data) {
    const currencyData = data[code as keyof typeof data]
