  ...
  <main class="p-2 lg:w-xl lg:mx-auto">
    <form @submit.prevent="submit">
			<fieldset class="fieldset w-full">
				...
				/>
				<span v-if="nameError" class="validator-hint">{{ nameError }}</span>
			</fieldset>
			...
			<fieldset class="fieldset w-full">
				...
				<span v-if="typeError" class="validator-hint">{{ typeError }}</span>
			</fieldset>

			<button class="btn btn-primary btn-block mt-4" :disabled="isLoading">
